...
function readAnswer(question) {
  ...
  if (question.type === 'nutrition') return Object.fromEntries(['agua', 'calorias', 'proteinas', 'carboidratos', 'gorduras', 'fibras'].map(id => [id, elements.form.querySelector(`[name="nutrition-${id}"]`).value || null]));
