...
Após salvar o Ponto de partida, o Flow também registra os dados estruturados disponíveis: data de nascimento e sexo em `/users/me`, eventos de peso e altura em `/events`, meta de peso em `/goals` e cada meta nutricional diária (água, calorias, proteínas, carboidratos, gorduras e fibras) em uma chamada própria para `/goals`.
